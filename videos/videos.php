        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h4 class="text-center my-5"><a href="http://localhost/faculta_main/DevelopmentEnvironment/main/videos/rpaFormularDASIAHotel.mp4" >Open MP4 in browser from directory.</a></h4>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h4 class="text-center my-5"><a href="http://localhost/faculta_main/DevelopmentEnvironment/main/videos/rpaLoginDASIAHotel.mp4" >Open MP4 in browser from directory.</a></h4>
                </div>
            </div>
